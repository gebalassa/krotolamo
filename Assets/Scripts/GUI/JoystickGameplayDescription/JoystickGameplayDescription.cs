...
public class JoystickGameplayDescription : OverlayObject
{
    [Header("UI")]
    [SerializeField] Image panelImage;
    [SerializeField] JoystickGameplayLayoutPlayer joystickGameplayLayoutPlayer;
    [SerializeField] JoystickGameplayLayoutSpectator joystickGameplayLayoutSpectator;
    ...
    {
        joystickGameplayLayoutPlayer.OnJoystick(action, playerIndex);
        joystickGameplayLayoutSpectator.OnJoystick(action, playerIndex);
